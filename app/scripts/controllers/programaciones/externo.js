...
/**
 * @ngdoc function
 * @name registroAltaFrontendApp.controller:ProgramacionesExternoCtrl
 * @description
 * # ProgramacionesExternoCtrl
 * Controller of the registroAltaFrontendApp
 */
angular.module('registroAltaFrontendApp')
.controller('ProgramacionesExternoCtrl', function ($scope, $utilsViewService, programacionesService, colaboradoresService) {
    $scope.init = function() {
        $scope.step = 1;
        $scope.dni_medico = '';
    ...
    $scope.search = function(dni_medico) {
        ...
        colaboradoresService.findByDni({dni: dni_medico}, function(data) {
            if (data.colaborador !== null) {
                ...
                $scope.trabajador.grupo_ocupacional = data.colaborador.grupo_ocupacional;
            } else {
                $scope.trabajador = {};
