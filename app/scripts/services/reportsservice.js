    ...
    .factory('reportsService', function ($resource, envService) {
        ...
        return $resource(envService.getHost() + endpointUrl + '/:id.json', {}, {
            ...
            getReportRangeDatesData: {
                method: 'GET',
                url: envService.getHost() + endpointUrl + '/get-report-range-dates-data/:start_date/:end_date.json'
            },
            getReportRangeDatesFile: {
                method: 'GET',
                responseType: 'arraybuffer',
                transformResponse: function(data, headersGetter, status) {
                    if (status === 200) {
                ...
                url: envService.getHost() + endpointUrl + '/get-report-range-dates-file/:start_date/:end_date.json'
            }
        });
    });